...
class QuoteBase(models.Model):
    ...
    author = models.CharField(_('author'), blank=False, null=False, max_length=255,
                                help_text=_("The author of the quote."))
    url_source = models.URLField(_('url source'), verify_exists=False, blank=True, null=True)
...
class Quote(QuoteBase):
    ...
    circa = models.CharField(_('circa'), blank=True, null=True, max_length=100, help_text="When was the quote created?")
    tags = TagField()
...
class Testimonial(QuoteBase):
    ...
    official_title = models.CharField(_('official title'), blank=True, null=True, max_length=255,
                                    help_text=_("The author's title. ie. Project Manager."))
    company = models.CharField(_('company'), blank=True, null=True, max_length=255,
                                    help_text=_("The company the author is associated with. ie. Acme Products"))
